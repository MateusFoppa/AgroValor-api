...
export default function FormCrudBatch(){
  ...
  function closeCreateModal() {
    ...
    const [isModalReadOpen, setReadModalOpen] = useState(false);
                    ...
                    <tbody>
                      {batch.map((data) => (
                        <tr key={data.id} className="border-b dark:border-gray-700">
                            ...
                            {/* <td className="flex-1 m-0 p-0 justify-end">
                                            <button type="button" onClick={openReadModal} data-modal-target="readProductModal" data-modal-toggle="readProductModal" className="flex w-full items-center py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white text-gray-700 dark:text-gray-200">
...
{isModalCreateOpen && (
<div id="createProductModal" tabIndex="-1" aria-hidden="true" className="overflow-y-auto overflow-x-hidden fixed z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
...
{isModalUpdateOpen && (
<div id="updateProductModal" tabIndex="-1" aria-hidden="true" className="overflow-y-auto h-full overflow-x-hidden fixed z-50 justify-center items-center w-full max-h-full">
    <div className="relative p-4 w-full max-w-2xl max-h-full">
...
{isModalReadOpen && (
<div id="readProductModal" tabIndex="-1" aria-hidden="true" className="overflow-y-auto h-full my-auto overflow-x-hidden fixed z-50 justify-center items-center w-full max-h-full">
    <div className="relative p-4 w-full max-w-xl max-h-full">
        ...
        <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div className="flex justify-between mb-4 rounded-t sm:mb-5">
                ...
                <div>
                    <button type="button" onClick={closeReadModal} className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 inline-flex dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="readProductModal">
                        <svg aria-hidden="true" className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" />
                        </svg>
                        <span className="sr-only">Close modal</span>
...
{isModalDeleteOpen && (
<div id="deleteModal" tabIndex="-1" aria-hidden="true" className="overflow-y-auto h-full my-auto overflow-x-hidden fixed z-50 justify-center items-center w-full max-h-full">
    <div className="relative p-4 w-full max-w-md max-h-full">
        <div className="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            <button type="button" onClick={closeDeleteModal} className="text-gray-400 absolute top-2.5 right-2.5 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="deleteModal">
                <svg aria-hidden="true" className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fillRule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
                <span className="sr-only">Close modal</span>
            ...
            <p className="mb-4 text-gray-500 dark:text-gray-300">Tem certeza que deseja excluir essa propriedade?</p>
            <div className="flex justify-center items-center space-x-4">
                <button onClick={closeDeleteModal} data-modal-toggle="deleteModal" type="button" className="py-2 px-3 text-sm font-medium text-gray-500 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">Não, cancelar</button>
                <button onClick={handlerDelete} type="submit" className="py-2 px-3 text-sm font-medium text-center text-white bg-red-600 rounded-lg hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-500 dark:hover:bg-red-600 dark:focus:ring-red-900">Sim, continuar</button>
            </div>
        </div>
    </div>
</div>
