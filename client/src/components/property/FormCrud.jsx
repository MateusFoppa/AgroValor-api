    ...
    <div className="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div className="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
            ...
            <div className="grid gap-4 mb-4 sm:grid-cols-2">
                ...
                <button type="button" onClick={handlerCreate} className="text-white inline-flex items-center bg-teal-500 hover:bg-teal-600 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
